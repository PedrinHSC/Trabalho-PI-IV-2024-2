...
import fundoNovidades from '../../../../assets/imagens/imagNovidades.png'
import CadastroProfessor from './cadastroProfessor/cadastroProfessor';
import CadastroNovidades from './cadastroNovidades/cadastroNovidades';
...
const Cadastro: React.FC = () => {
  ...
  const cadastroArray = [
    ...
    { cadastro: 'Professor', imagem: fundoProfessor, width: '308px', height: '225px', component: <CadastroProfessor /> },
    { cadastro: 'Novidades', imagem: fundoNovidades, width: '308px', height: '225px', component: <CadastroNovidades /> },
  ];
